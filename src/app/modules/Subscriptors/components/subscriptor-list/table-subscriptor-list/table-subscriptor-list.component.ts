...
@Component({
  selector: 'app-table-subscriptor-list',
  templateUrl: './table-subscriptor-list.component.html',
  styleUrls: ['./table-subscriptor-list.component.css'],
})
export class TableSubscriptorListComponent implements OnInit {
  ...
  // displayedHeaders: string[] = [];
  // public dataSource = new MatTableDataSource<any>(this.initialData);
  ...
  loadData() {
    ...
    //   }
    // });
    this.dataSource = new MatTableDataSource<any>(this.GridArray);
